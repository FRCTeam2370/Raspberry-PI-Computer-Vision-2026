...
CAMERA_FOV_HORIZONTAL = 0.7892999999999791   # CAMERA_FOV_HORIZONTAL should be in radians
CAMERA_FOV_VERTICAL = 0.49510000000001153   # CAMERA_FOV_VERTICAL should be in radians
...
while cap.isOpened():
    ...
    if success:
        ...
        if intake_down:
            ...
            table.putNumber("number_of_fuel", len(weights))
            ...
            table.putNumber("number_of_fuel", 0)
            table.putNumberArray("yaw_radians", [0])
            table.putNumberArray("distance", [0])
            table.putNumberArray("weights", [0])
